...
//        dummyData();
    ...
    {
        mLstProductCats = new ArrayList<>();
        new SaleAPIHelper(getActivity()).getProductCategories(mTableInfo.getAreaId(), Constants.DRINK_CATEGORY, mHandlerProductCat, true);
    }
    ...
    private void dummyData()
    {
        ...
        for(int i=0; i<20; i++) {
            ...
            info.setId(i);
            info.setTenNhom("Product Drinking " + i);
